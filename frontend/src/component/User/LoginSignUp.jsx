...
const LoginSignup = () => {
  ...
  useEffect(() => {
    if(flag){
      alert.error("Password should not be lesser then 8 characters");
  ...
  }, [dispatch, error, flag, alert, isAuthenticated, navigate, redirect]);
      ...
      <div className="LoginSignUpContainer">
        <div className="LoginSignUpBox">
          ...
          <form className="loginForm" ref={loginTab} onSubmit={loginSubmit}>
            ...
            {/* <input type="submit" value="Login with Google" className="loginBtn" /> */}
          </form>
          <form
